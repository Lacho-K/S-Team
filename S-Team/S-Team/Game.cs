                ...
                Dictionary<string, int> months = new Dictionary<string, int>()
{
                ...
                if (RDData.Length == 5 && months.ContainsKey(RDData[2].ToLower()))
                {
                    result = months[RDData[2].ToLower()] * 100 + int.Parse(RDData[3]) + int.Parse(RDData[4]) * 10000;
                }
                else if(RDData.Length == 5 && months.ContainsKey(RDData[3].ToLower()))
                {
                    result = months[RDData[3].ToLower()] * 100 + int.Parse(RDData[2]) + int.Parse(RDData[4]) * 10000;
                }
                else if(RDData.Length == 3)
                {
                    result =  int.Parse(RDData[2]) * 10000;
                }
                else if(RDData.Length == 4 && months.ContainsKey(RDData[2].ToLower()))
                {
                    result = months[RDData[2].ToLower()] * 100 + int.Parse(RDData[3]) * 10000;
                }
