        ...
        static void Main()
        {
            ...
            while (true)
            {
                ...
                else if(userInputData.Length > 3 && userInputData[0] == "remove" && userInputData[1] == "from" && userInputData[2] == "library")
                {
                    ...
                    Console.WriteLine();
                    char potentialIndex;
                    bool isChar = char.TryParse(userInputData[3], out potentialIndex);
                    if (isChar)
                    {
                        if (char.IsDigit(potentialIndex))
                        {
                            library.RemoveAt(int.Parse(potentialIndex.ToString()));
                        }
                        else
                        {
                            Console.WriteLine(potentialIndex + " is not an index!");
                        }
                    }
                    else
                    {
